...
LRESULT CALLBACK WndProc(HWND hWnd, UINT iMessage, WPARAM wParam, LPARAM lParam)
{
	...
	{
	case WM_LBUTTONDOWN:	// 마우스 좌클릭 시: 이름 표시하기
		MessageBox(hWnd, TEXT("제 이름은 김지현입니다."), TEXT("이름"), MB_OK);
		return 0;

	case WM_RBUTTONDOWN:	// 마우스 우클릭 시: 학번 표시하기
		MessageBox(hWnd, TEXT("제 학번은 25311004입니다."), TEXT("학번"), MB_OKCANCEL);
		return 0;
